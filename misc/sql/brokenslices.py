...
def stackid_from_title():
    stack_id = ("SELECT id FROM stack WHERE title={a};")
    return stack_id.format(a=stacktitle)


def testdb_cursor_conn():
    with open("/home/emtracer/Downloads/catmaiddb.example.json", 'r') as fil:
...
stacktitle = "''"  # Input Stack Title Here
...
catmaiddb = "/home/emtracer/Downloads/catmaiddb.example.json"
curs, conn = testdb_cursor_conn()
stack_id = stackid_from_title()
curs.execute(stack_id)
